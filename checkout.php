       ...
       <ul>
        ...
        <?php
         $rem=$_GET['rem'];
          $tname = "cart";
          if($rem != "0")
         { $sql20 = "DELETE from $tname where id ='$rem'";
    ...
    ?>
                 ...
                 if ($result->num_rows > 0) {
                  while($row = $result->fetch_assoc()) {
                    if($itr==$count)
                      ...
                      $link = "checkout.php?rem=".$row["id"];
                      echo "<td><a href='".$link."'><img src='images/subtract.png'></a></img></td>";
                      echo "</tr>";
                    $itr++;
        ...
        echo "</table>";
           ...
           if($flag1 == 'true')
             ...
             <a href="logincart.php?cart=1"><input type="submit" name="Submit" value="Checkout"></a>
           </div>';
           ?>
