    	      ...
    	      <h4 class="title">Create an Account</h4>
    		   <form action="reg.php" method="post">
    			 <div class="col_1_of_2 span_1_of_2">
		   			 <div>Username*:<input type="name" name="username" required></div>
		    			<div>Password*:<input type="password" name="password" required></div>
		    			<div>E-Mail*:<input type="email" name="email" required></div>
		    			<div>Name*: <input type="name" name="name" required></div>
		    	 </div>
		    	  <div class="col_1_of_2 span_1_of_2">	
		    		<div>Address:<input type="name" name="address"></div>
		    				        
		          <div>City: <input type="name" name="city" ></div>
