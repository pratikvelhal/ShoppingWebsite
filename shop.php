	 ...
	 <div class="wrap"> 
	    ...
	    <div class="cssmenu"; style="float:right;">
		   <ul>
		   	...
		   	session_start();
		   	if($orderflag == "def")
		   	$_SESSION['orderflag'] = "id";

		  	else if($orderflag == "inc")
		  	$_SESSION['orderflag'] = "cost";	
		  		else if($orderflag == "dec")
		  	$_SESSION['orderflag'] = "cost DESC";	
       ...
       <div class="login">
		...
		<div class="cont span_2_of_3"; style="margin-left:150px;">
		  <div class="mens-toolbar" style="margin-left:-23px;">
    		 ...
    		 <div class="sort">  
    		<a href = "shop.php?id=<?php echo $tname;?>&orderflag=def">Default</a>
    		<a href = "shop.php?id=<?php echo $tname;?>&orderflag=inc">Increasing price</a>
    		<a href = "shop.php?id=<?php echo $tname;?>&orderflag=dec">Decreasing price</a>
    		 </div>  
	          <div class="pager">   
     	    ...
     	    <div class="clear"></div>
			    ...
			    <div class="box1">
			    	<?php 
					  	...
					  	$cost =	$_SESSION['orderflag'];
					  	$sql="SELECT id from $tname ORDER BY $cost ";
				   ...
				   <div class="col_1_of_single1 span_1_of_single1"><a href="single.php?mainid=<?php echo"$tname";?>&subid=<?php echo"$param1";?>">
				     <div class="view1 view-fifth1">
				  	  <div class="top_box">
					  	...
					  	$sql="SELECT name from $tname ORDER BY $cost";
					  	 $result = $conn->query($sql);
					  		 if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
    	if($itr==0)
    	...
    	$itr++;
				         ...
				         <div class="grid_img">
					  	...
					  	$itr = 0;
					  	$cost =	$_SESSION['orderflag'];
					  	$sql="SELECT picpath from $tname ORDER BY $cost ";
					  	 $result = $conn->query($sql);
					  		 if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
    	if($itr==0)
    	...
    	$itr++;
                       ...
                       <div class="price">Rs. <?php 
					  	$itr = 0;
					  	$cost =	$_SESSION['orderflag'];
					  	$sql="SELECT cost from $tname ORDER BY $cost ";
					  	 $result = $conn->query($sql);
					  		 if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
    	if($itr==0)
